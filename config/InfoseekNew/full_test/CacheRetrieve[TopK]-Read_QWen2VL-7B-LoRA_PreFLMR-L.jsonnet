...

{
    agent_config:  {
        ...
        retriever_config: retrievers.InfoseekNew_testfull_CacheRerankDatasetRetriever_ViT_L {
            retrieval_field: "retrieved_passage"
        },
        // retriever_config: retrievers.InfoseekNew_FullPassage_PreFLMRRetriever_ViT_L,
    },
