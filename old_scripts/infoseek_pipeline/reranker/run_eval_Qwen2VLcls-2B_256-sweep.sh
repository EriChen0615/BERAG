#!/bin/bash
#SBATCH -J run_OKVQA_valid_eval_reranker_QWen2VL-2B_sweep
...
RERANK_TOPK=50
POST_RETRIEVAL_DATASET="outputs/0jingbiao_mei/Infoseek-test256-with-retrieval"
...
for checkpoint in {1000..5000..500}; do
    MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-2b/qlora/infoseek/2024-12-28_doc1_verify/checkpoint-$checkpoint"
    POST_RERANK_DATASET="outputs/0jingbiao_mei/Infoseek-test256-with-retrieval-$checkpoint"
