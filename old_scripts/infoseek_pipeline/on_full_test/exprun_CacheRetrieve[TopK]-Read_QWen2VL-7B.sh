...
declare -A exp7
exp7['custom_name']="rag5-dpo-nosft-beta=1.2-ckpt718"
exp7['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek/rag5_answer-dpo_max=4096_beta=1.2/checkpoint-718"
exp7['retrieve_topk']=1
exp7['base_model_path']="data/jinghong_chen/Qwen2-VL-7B-Instruct_Infoseek-RAG1_LoRA-SFT"

declare -A exp8
exp8['custom_name']="rag5-dpo-nosft-beta=1.2-ckpt718"
exp8['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek/rag5_answer-dpo_max=4096_beta=1.2/checkpoint-718"
exp8['retrieve_topk']=5
exp8['base_model_path']="data/jinghong_chen/Qwen2-VL-7B-Instruct_Infoseek-RAG1_LoRA-SFT"
