#!/bin/bash
#SBATCH -J Infoseek_sample_rag3_on_train_QWen2-7B
...
CUSTOM_NAME="RAG-Top3"
IMG_BASEDIR="/rds/project/rds-iS0FZqj9lmg/wl356/infoseek/infoseek_images/images"
TAKE_N=64000
# TAKE_N=0

MODEL_PATH="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek_new/rag1_answer/checkpoint-2000"
