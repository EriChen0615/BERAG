#!/bin/bash
#!/bin/bash
#SBATCH -J EVQA_Test256_Rerank_2Bsweep
...
# sweep from 1000 to 5000 

# Loop through checkpoints
for checkpoint in {3000..5000..1000}; do
    MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-2b/qlora/evqa/2025-01-01_doc1_verify/checkpoint-$checkpoint"
    POST_RERANK_DATASET="outputs/0jingbiao_mei/EVQA-test256-with-retrieval-rerankHyper-$checkpoint"
