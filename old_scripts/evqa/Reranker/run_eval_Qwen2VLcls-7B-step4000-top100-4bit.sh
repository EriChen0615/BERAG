#!/bin/bash
#!/bin/bash
#SBATCH -J EVQA_TestFull_Rerank7b-top100-4bit
...
POST_RERANK_DATASET="outputs/0jingbiao_mei/EVQA-testfull-with-retrieval-rerank7B-step4000-top100-4bit"
...
MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-7b/qlora/evqa/2025-01-01_doc1_verify/checkpoint-4000"
