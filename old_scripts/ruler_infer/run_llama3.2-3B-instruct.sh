...
#
# RULER inference for meta-llama/Llama-3.2-3B-Instruct (128k context).
# Sweeps across available context lengths. Uses meta-llama3 chat template.
#
# Submit: cd A-RAVQA && sbatch scripts/ruler_infer/run_llama3.2-3B-instruct.sh
# Run interactively: bash scripts/ruler_infer/run_llama3.2-3B-instruct.sh
#
