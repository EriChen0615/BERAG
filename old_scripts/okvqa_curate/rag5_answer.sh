...
DROP_MAX_TOKENS=2048 # For OKVQA. This filters out 0% (i.e, document truncations are small)
python src/curate/rag5_answer.py \
    --input_csvfile $INPUT_CSV \
    --sample_size_train 0 \
    --output_dir "third_party/LLaMAFactory/data/jinghong_chen/okvqa/rag5-answer-sft_max=${DROP_MAX_TOKENS}" \
    --mode "sft" \
    --report_token_length \
