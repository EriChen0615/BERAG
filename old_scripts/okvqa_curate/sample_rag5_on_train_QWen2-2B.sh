...
#SBATCH -p ampere
#SBATCH --array=2-7 # Adjust this based on the number of experiments
...
MODEL_PATH="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag1_answer/checkpoint-1686"
SEEDS=(1129 42 122423 615926 2313 2341 53 0 1214)
