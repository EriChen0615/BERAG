...
MERGED_MODEL_PATH="${MERGED_MODEL_PATH:-data/jinghong_chen/LLaVA-Llama3-8B-v1_1-transformers_EVQA-RAG5_LoRA-SFT}"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-outputs/0526/EVQA/LLaVA-Llama3/VLLM/sft_merged}"
...
generate_exp_name() {
    local topk="$1"
    local name="EVQA-VLLM-LLaVA-Llama3-SFT-Merged-Top${topk}"
