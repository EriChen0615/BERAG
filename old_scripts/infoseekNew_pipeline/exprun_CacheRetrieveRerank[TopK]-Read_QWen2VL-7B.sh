...
declare -A exp12
exp12['custom_name']="rag1_answer_dpo_beta=0.1_ckpt1295"
exp12['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek_new/rag1_answer-dpo_max=8196_beta=0.1/checkpoint-1295"
...
# declare -A exp27
# exp27['custom_name']="rag1_answer_dpo_beta=2.0_ckpt1295"
# exp27['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek_new/rag1_answer-dpo_max=8196_beta=2.0/checkpoint-1295"
# exp27['retrieve_topk']=1
# exp27['base_model_path']="data/jinghong_chen/Qwen2-VL-7B-Instruct_InfoseekNew-RAG1_LoRA-SFT"
...
# experiments=("exp20" "exp21" "exp22")
# experiments=("exp23")
experiments=("exp24" "exp25" "exp26")
# experiments=("exp27")
