#!/bin/bash
#SBATCH -J run_InfoseekNew_full_reranker_7b_baseline
...
POST_RERANK_DATASET="outputs/0jingbiao_mei/InfoseekNew-test-with-retrieval-baseline7B-1000"
...
MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/saves/qwen2_vl-7b/lora/infoseeknew/doc1_verify/checkpoint-1000"
