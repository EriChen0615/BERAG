#!/bin/bash
#SBATCH -J run_InfoseekNew_valid_eval_reranker_QWen2VL-2B
...
POST_RERANK_DATASET="outputs/0jingbiao_mei/InfoseekNew-test_full-with-retrieval-step3000"
...
MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-2b/qlora/infoseeknew/2025-01-24_doc1_verify/checkpoint-3000"
