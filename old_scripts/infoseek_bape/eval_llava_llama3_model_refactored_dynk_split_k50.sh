...
# Usage:
#   sbatch scripts/infoseek_bape/eval_llava_llama3_model_refactored_noprune_split_k50.sh
#   CHECKPOINT_PATH=/path/to/checkpoint sbatch scripts/infoseek_bape/eval_llava_llama3_model_refactored_noprune_split_k50.sh
#
# This wrapper is intended for evaluation environments. It reads cached
# inference_results.csv files produced by the matching split run_llava... script.
...
echo "Running eval chunk ${CHUNK_INDEX} with offset=${DS_OFFSET}, take_n=${TAKE_N}"
