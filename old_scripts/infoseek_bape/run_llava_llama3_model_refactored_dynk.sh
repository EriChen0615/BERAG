...
# Usage:
#   bash scripts/infoseek_bape/run_llava_llama3_model_refactored_noprune.sh
#   CHECKPOINT_PATH=/path/to/checkpoint bash scripts/infoseek_bape/run_llava_llama3_model_refactored_noprune.sh
