...
RETRIEVAL_TOPK_LIST=(3 5 7)
# RETRIEVAL_TOPK_LIST=(3)
# RETRIEVAL_TOPK_LIST=(10 12 15 20 25 30)
# RETRIEVAL_TOPK_LIST=(1 2 3 5)
...
declare -A base_experiments=(
    ...
    # ["EVQA-BAPE-BEFT[K*=2]-l1h4-beamsearch_bs=3"]="exp_rag2_beft_k2_l1h4_beamsearch_bs3"
...
declare -A exp_rag2_beft_k2_l1h4_beamsearch_bs3=(
    [model_path]="Qwen/Qwen2-VL-2B-Instruct"
    [processor_path]="Qwen/Qwen2-VL-2B-Instruct"
...
for base_exp_name in "${!base_experiments[@]}"; do
    ...
    for retrieval_topk in "${RETRIEVAL_TOPK_LIST[@]}"; do
        ...
        echo "Num beams: ${exp_cfg[num_beams]}"
        echo "Passage prior: $PASSAGE_PRIOR"
        echo "Inference engine version: v2"
        ...
        args=(
            ...
            --seed 0
            --batch_size 1
            --exp_name "outputs/1125/BAPE/${full_exp_name}"
