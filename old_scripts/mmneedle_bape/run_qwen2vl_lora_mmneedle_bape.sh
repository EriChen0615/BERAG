...
declare -A base_experiments=(
  ["MMNeedle-BAPE-BEFT-Qwen2VL2B"]="exp_mmneedle_qwen2vl2b_beft"
  # ["MMNeedle-BAPE-BEFT-Qwen2VL2B-ckpt200"]="exp_mmneedle_qwen2vl2b_beft_ckpt200"
)

declare -A exp_mmneedle_qwen2vl2b_beft=(
  [model_path]="Qwen/Qwen2-VL-2B-Instruct"
  [processor_path]="Qwen/Qwen2-VL-2B-Instruct"
  [adapter_path]="third_party/LLaMA-Factory-2502/saves/qwen2_vl-2b/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-1242"
  [prior_head_path]="third_party/LLaMA-Factory-2502/saves/qwen2_vl-2b/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-1242/prior_head.pt"
...
declare -A exp_mmneedle_qwen2vl2b_beft_ckpt200=(
  [model_path]="Qwen/Qwen2-VL-2B-Instruct"
  [processor_path]="Qwen/Qwen2-VL-2B-Instruct"
  [adapter_path]="third_party/LLaMA-Factory-2502/saves/qwen2_vl-2b/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-200"
  [prior_head_path]="third_party/LLaMA-Factory-2502/saves/qwen2_vl-2b/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-200/prior_head.pt"
  [hidden_state_offset]="4"
  [prior_head_modeling]="mlp_head"
  [prior_head_num_layers]="2"
  [prior_head_proj_dim]="1024"
