...
#SBATCH -p ampere
#SBATCH -J mmneedle_bape_qwen7b_noz0
set -euo pipefail
...
ADD_Z0="${ADD_Z0:-false}"  # no_z0 checkpoint by default
...
# Trained no-z0 checkpoint.
CHECKPOINT_DIR="${CHECKPOINT_DIR:-third_party/LLaMA-Factory-2502/saves/qwen2_vl-7b/lora/mmneedle/beft/qwen2_vl-7b-rag10-n1x1-k2-no_z0-size10000-offset0/checkpoint-1242}"
CHECKPOINT_DIR_STEP200="${CHECKPOINT_DIR_STEP200:-third_party/LLaMA-Factory-2502/saves/qwen2_vl-7b/lora/mmneedle/beft/qwen2_vl-7b-rag10-n1x1-k2-no_z0-size10000-offset0/checkpoint-200}"
CHECKPOINT_DIR_R8="${CHECKPOINT_DIR_R8:-third_party/LLaMA-Factory-2502/saves/qwen2_vl-7b/lora/mmneedle/beft/qwen2_vl-7b-rag10-n1x1-k2-no_z0-r8-size10000-offset0/checkpoint-1242}"

declare -A base_experiments=(
  # ["MMNeedle-BAPE-BEFT-Qwen2VL7B-no_z0"]="exp_mmneedle_qwen2vl7b_no_z0_beft"
  # ["MMNeedle-BAPE-BEFT-Qwen2VL7B-no_z0-step200"]="exp_mmneedle_qwen2vl7b_no_z0_beft_step200"
  ["MMNeedle-BAPE-BEFT-Qwen2VL7B-no_z0-r8"]="exp_mmneedle_qwen2vl7b_no_z0_beft_r8"
)

declare -A exp_mmneedle_qwen2vl7b_no_z0_beft=(
...
declare -A exp_mmneedle_qwen2vl7b_no_z0_beft_step200=(
  [model_path]="Qwen/Qwen2-VL-7B-Instruct"
  [processor_path]="Qwen/Qwen2-VL-7B-Instruct"
  [adapter_path]="${CHECKPOINT_DIR_STEP200}"
  [prior_head_path]="${CHECKPOINT_DIR_STEP200}/prior_head.pt"
  [hidden_state_offset]="4"
  [prior_head_modeling]="mlp_head"
  [prior_head_num_layers]="2"
  [prior_head_proj_dim]="1024"
...
declare -A exp_mmneedle_qwen2vl7b_no_z0_beft_r8=(
  [model_path]="Qwen/Qwen2-VL-7B-Instruct"
  [processor_path]="Qwen/Qwen2-VL-7B-Instruct"
  [adapter_path]="${CHECKPOINT_DIR_R8}"
  [prior_head_path]="${CHECKPOINT_DIR_R8}/prior_head.pt"
  [hidden_state_offset]="4"
  [prior_head_modeling]="mlp_head"
  [prior_head_num_layers]="2"
  [prior_head_proj_dim]="1024"
