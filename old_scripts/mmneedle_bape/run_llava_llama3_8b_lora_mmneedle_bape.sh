...
#SBATCH -p ampere
#SBATCH -J mmneedle_bape_llava8b
set -euo pipefail
...
declare -A base_experiments=(
  ["MMNeedle-BAPE-BEFT-LLaVA-Llama3-8B-v1_1"]="exp_mmneedle_llava_llama3_8b_v1_1_beft"
)

declare -A exp_mmneedle_llava_llama3_8b_v1_1_beft=(
  [model_path]="xtuner/llava-llama-3-8b-v1_1-transformers"
  [processor_path]="xtuner/llava-llama-3-8b-v1_1-transformers"
  [adapter_path]="third_party/LLaMA-Factory-2502/saves/llava_llama3_8b_v1_1_transformers/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-1242"
  [prior_head_path]="third_party/LLaMA-Factory-2502/saves/llava_llama3_8b_v1_1_transformers/lora/mmneedle/beft/rag10-n1x1-k2-size10000-offset0/checkpoint-1242/prior_head.pt"
