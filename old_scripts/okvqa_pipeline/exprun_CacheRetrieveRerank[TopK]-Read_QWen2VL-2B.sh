...
declare -A exp4
exp4['custom_name']="cont-rag1-ft_ckpt-1000"
exp4['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/cont_rag1_answer/checkpoint-1000"
exp4['retrieve_topk']=1
exp4['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-NoRAG-SFT"
declare -A exp5
exp5['custom_name']="cont-rag1-ft_ckpt-1000"
exp5['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/cont_rag1_answer/checkpoint-1000"
exp5['retrieve_topk']=3
exp5['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-NoRAG-SFT"
declare -A exp6
exp6['custom_name']="cont-rag1-ft_ckpt-1000"
exp6['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/cont_rag1_answer/checkpoint-1000"
exp6['retrieve_topk']=5
exp6['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-NoRAG-SFT"
declare -A exp7
exp7['custom_name']="cont-rag1-ft_ckpt-1000"
exp7['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/cont_rag1_answer/checkpoint-1000"
exp7['retrieve_topk']=10
exp7['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-NoRAG-SFT"
...
# declare -A exp15
# exp15['custom_name']="rag5-dpo_beta=0.1_ckpt-234"
# exp15['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag5_answer-dpo_beta=0.1/checkpoint-234"
# exp15['retrieve_topk']=10
# exp15['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-RAG5_LoRA-SFT"

declare -A exp12
exp12['custom_name']="rag5-dpo_beta=0.5_ckpt-234"
exp12['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag5_answer-dpo_beta=0.5/checkpoint-234"
exp12['retrieve_topk']=1
exp12['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-RAG5_LoRA-SFT"
declare -A exp13
exp13['custom_name']="rag5-dpo_beta=0.5_ckpt-234"
exp13['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag5_answer-dpo_beta=0.5/checkpoint-234"
exp13['retrieve_topk']=3
exp13['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-RAG5_LoRA-SFT"
declare -A exp14
exp14['custom_name']="rag5-dpo_beta=0.5_ckpt-234"
exp14['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag5_answer-dpo_beta=0.5/checkpoint-234"
exp14['retrieve_topk']=5
exp14['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-RAG5_LoRA-SFT"
declare -A exp15
exp15['custom_name']="rag5-dpo_beta=0.5_ckpt-234"
exp15['model_path']="third_party/LLaMAFactory/saves/qwen2_vl-2b/lora/okvqa/rag5_answer-dpo_beta=0.5/checkpoint-234"
exp15['retrieve_topk']=10
exp15['base_model_path']="data/jinghong_chen/Qwen2-VL-2B-Instruct_OKVQA-RAG5_LoRA-SFT"
...
# experiments=("exp4" "exp5" "exp6" "exp7" "exp8" "exp9" "exp10" "exp11")
# experiments=("exp7")
# experiments=("exp8" "exp9" "exp10" "exp11")
