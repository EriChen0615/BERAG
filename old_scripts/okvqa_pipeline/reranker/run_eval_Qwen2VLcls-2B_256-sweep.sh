...
RERANK_TOPK=50
POST_RETRIEVAL_DATASET="outputs/0jingbiao_mei/OKVQA-valid256-with-retrieval"
...
for checkpoint in {800..1600..200}; do
    MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-2b/qlora/okvqa/2024-12-28_doc1_verify/checkpoint-$checkpoint"
    POST_RERANK_DATASET="outputs/0jingbiao_mei/OKVQA-valid256-with-retrieval-$checkpoint"
