#!/bin/bash
#SBATCH -J run_OKVQA_valid_eval_reranker_QWen2VL-2B-top100
...
POST_RERANK_DATASET="outputs/0jingbiao_mei/OKVQA-valid-with-retrieval-step1200-top100"
...
MODEL_PATH="/home/jm2245/rds/rds-cvnlp-hirYTW1FQIw/shared_space/jm2245/LAMAFACT-MMHS/checkpoints/qwen2_vl-2b/qlora/okvqa/2024-12-28_doc1_verify/checkpoint-1200"
