...
#SBATCH -p ampere
#SBATCH --output=/home/jc2124/rds/rds-cvnlp-hirYTW1FQIw/shared_space/A-RAVQA/logs/slurm_slidevqa_bape_speed_dynamic.out
#SBATCH --error=/home/jc2124/rds/rds-cvnlp-hirYTW1FQIw/shared_space/A-RAVQA/logs/slurm_slidevqa_bape_speed_dynamic.err
...
EXP_DIR="${ROOT}/outputs/0426/SlideVQA-inference-analysis/BAPE-dynamicTopP/all-slides-K=${RETRIEVAL_TOPK}-TopP=${DYNAMIC_K_TOP_P}-TakeN=${TAKE_N}-MBPF=${MAX_BATCH_SIZE_PER_FORWARD}"
mkdir -p "${EXP_DIR}"
