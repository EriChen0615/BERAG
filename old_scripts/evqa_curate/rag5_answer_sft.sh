...
INPUT_CSV="data/jinghong_chen/EVQA_QWen2-VL-7B_self-generated-pairs_n=8.csv"
DROP_MAX_TOKENS=4096
SAMPLE_SIZE=64000
python src/curate/rag5_answer.py \
    --input_csvfile $INPUT_CSV \
    --sample_size_train $SAMPLE_SIZE \
    --output_dir "third_party/LLaMAFactory/data/jinghong_chen/evqa/7B-rag5-answer-sft_max=${DROP_MAX_TOKENS}-size=${SAMPLE_SIZE}" \
    --mode "sft" \
    --report_token_length \
