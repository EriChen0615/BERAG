#!/bin/bash
#SBATCH -J sample_rag3_on_train_QWen2-7B
...
MODE="SampleCacheRetrieve[Top3]-Read"
CONFIG_FILE="config/${DATASET_NAME}_pipeline/${MODE}_${MODEL_NAME}_${RETRIEVER_NAME}.jsonnet"
CUSTOM_NAME="RAG-Top1_basemodel"
IMG_BASEDIR="../vqa_data/KBVQA_data/EVQA/images/"
TAKE_N=64000
# TAKE_N=0

MODEL_PATH="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/rag1_answer/checkpoint-7500"
