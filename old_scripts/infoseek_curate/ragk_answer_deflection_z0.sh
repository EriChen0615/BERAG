...
# Script to generate BEFT training data with controlled deflection ratio and z0 passage
# Samples data points with TopK=2, precisely controlling deflection=0/1 ratio
# Includes z0 passage (empty text passage) for each example
...
OUTPUT_DIR="third_party/LLaMAFactory/data/jinghong_chen/Infoseek/rag${TOPK_DOCS}-answer-controlled-deflection-ratio=${DEFLECTION_RATIO}-z0-size=${SAMPLE_SIZE}-max=${DROP_MAX_TOKENS}"
