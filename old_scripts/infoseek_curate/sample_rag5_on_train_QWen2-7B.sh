#!/bin/bash
#SBATCH -J Infoseek_sample_rag5_on_train_QWen2-7B
...
#SBATCH -p ampere
#SBATCH --array=0-6 # Adjust this based on the number of experiments
...
MODE="SampleCacheRetrieve[TopK]-Read"
...
MODEL_PATH="third_party/LLaMAFactory/saves/qwen2_vl-7b/lora/infoseek/rag1_answer/checkpoint-2000"
