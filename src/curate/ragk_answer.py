...
def process_item(item, prompt_template, pid_to_content_map):
    ...
    if gt_title != "":
        input_text_gtdoc = prompt + f'\n[EVIDENCE] Title={gt_title}; Content={truncate_doc(gt_content)}\n[ANSWER] '
    else:
        input_text_gtdoc = prompt + f'\n[EVIDENCE] Content={truncate_doc(gt_content)}\n[ANSWER] '
    if retrieved_doc_title != "":
        input_text_retdoc = prompt  + f'\n[EVIDENCE] Title={retrieved_doc_title}; Content={truncate_doc(retrieved_doc_content)}\n[ANSWER] '
    else:
        input_text_retdoc = prompt  + f'\n[EVIDENCE] Content={truncate_doc(retrieved_doc_content)}\n[ANSWER] '
